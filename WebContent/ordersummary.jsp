...
String sql ="SELECT * FROM orderinfo where customer_id='"+n+"' and (status !='cancelled' or status is null) ORDER BY date DESC";
...
<tr>
                ...
                <td colspan="5">  <div class="form-group" align="center">
                    <h7 style=" margin-left: 20px;">Receiver: </h7H>
...
<%}
	...
	session.setAttribute("msg","You don't have any previous order.");
	out.println("You don't have any previous order.");
