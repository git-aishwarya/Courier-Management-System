              ...
              <div class="nav-body">
                <ul class="nav-items">
                 ...
                 <li class="items"><a href="update.html">Update Status</a></li>
                  <li class="items"><a href="neworder.jsp">New Order</a></li>
...
String sql ="SELECT * FROM orderinfo where status NOT LIKE 'cancelled' or status is null";
...
<tr>
                 ...
                 <td colspan="5"> <div class="form-group" align="center">
                    <h7 style=" margin-left: 20px;">Sender's Name: </h7H>
                   
                  </div>
</td>

                <td colspan="5">  <div class="form-group" align="center">
                    <h7 style=" margin-left: 20px;">Receiver's Name: </h7H>
...
<td colspan="5">
<div class="form-group" align="center">
<h7 style="color:black; margin-left: 20px;"><%=rs.getString("receiver_name") %></h7H>
</div><%out.println("lm6"); %>
</td>
<td colspan="5">
<div class="form-group" align="center">
...
<%}else{
	session.setAttribute("cn"," You don't have any previous order.");
