	...
	<div class="fluid-container">
		<div class="wrapper">
			<div class="row">
				...
				<%String city=(String)session.getAttribute("acity");
				...
				<%if(session.getAttribute("s")!=null){%>
                    <h5 style="color:red;"><%=session.getAttribute("s")%></h5>
								...
								<form METHOD="POST"
									...
									<% 
										try {
											Class.forName("com.mysql.jdbc.Driver");
											Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/cms", "root", "anu123456");
											String sql2 = "SELECT COUNT(*)AS totalorder from orderinfo WHERE sender_city='"+city+"'and (status !='"+k+"'or status is null)";
											Statement st = con.createStatement();
									...
									<% 
										try {
											Class.forName("com.mysql.jdbc.Driver");
											Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/cms", "root", "anu123456");
											String sql3 = "SELECT SUM(total_amount) AS totalincome FROM orderinfo where sender_city='"+city+"'  and (status !='"+k+"'or status is null)";
											Statement st = con.createStatement();
									...
									<div class="form-group">
										<h6>Total Income</h6>
										<p style="color:black"><%=rs.getString("totalincome")%></p>
									</div>
									<%
										con.close();
										} catch (Exception e) {
